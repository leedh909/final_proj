      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>Azanda. <br></strong></h1>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">아무곳에서나 자지 않는 당신을 위한 숙박 공유 사이트</p>
