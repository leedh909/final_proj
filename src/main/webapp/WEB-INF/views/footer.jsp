...
<body>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md" style="margin-right : 100px;">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              <h2 class="ftco-heading-2">호스팅 하기</h2>
              <ul class="list-unstyled">
                <li><a href="HowToHosting.do" class="py-2 d-block">숙소 호스팅</a></li>
                <li><a href="income.do" class="py-2 d-block">호스트 수입 지급 방법</a></li>
                <li><a href="becomeHost.do" class="py-2 d-block">호스팅 시작방법</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
  ...
  Copyright &copy; WeMakeFriends Inc. All rights reserved
